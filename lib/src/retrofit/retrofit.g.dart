...
class _RestClient implements RestClient {
  ...
  Future<GetResponseMessage> updateUserProfile(
    ...
    if (avatarImg != null) {_data.files.add(MapEntry(
        'avatar_img',
  ...
  Future<GetResponseMessage> getCaption(img) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetResponseMessage>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/users/getcaption',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = GetResponseMessage.fromJson(_result.data!);
    return value;
  ...
  Future<ListTopPostInContestResponseMessage> getListTopPostInContest(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ListTopPostInContestResponseMessage>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/contests/getlisttoppostcontest',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListTopPostInContestResponseMessage.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ListSearchPostResponseMessage> searchPostByKey(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ListSearchPostResponseMessage>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/posts/searchpostbykey',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListSearchPostResponseMessage.fromJson(_result.data!);
    return value;
  ...
  Future<ListSearchPostResponseMessage> searchMorePostByKey(
      searchString, limitPost, dateBoundary) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'searchString': searchString,
      r'limitPost': limitPost,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ListSearchPostResponseMessage>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/posts/searchmorepostbykey',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListSearchPostResponseMessage.fromJson(_result.data!);
    return value;
